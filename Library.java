...
import java.util.*;
/*
 * Library class extends building class to include info specific to library
 */
public class Library extends Building {
  ...
  static Scanner scanner = new Scanner(System.in); //initializes scanner for user input
     ...
     * @param int nFloors: the number of floors the library has
     */
  ...
  /*
   * Method to addTitle
   * @param String title: the title of the book to be added to collection
   */
  ...
  /*
   * Method to removeTitle
   * @param String title: the title of the book to be removed
   * @return title
   * removes title if it is found in collection, otherwise prompts to continue or abandon mission. throws exception if user says "yes" to continue
   */
  public String removeTitle(String title){ //removes a book from the library collection
    if (this.collection.containsKey(title)) { //checks if the library has the book
      ...
      }else if (response.equals("no")) { //if they realize their error, don't end the code with an exception. let it continue
   ...
   * @param String title: the title to be checked out
   * throws exception if title not in collection
   * checks if title is checked out or available
   */
  ...
  /*
   * Method to returnBook
   * @param String title: title of the book to be returned
   * checks if title was originally in library, is currently checked in, and returns if none of the above
   */
  ...
  /*
   * Method to check if a certain book is in the library
   * @param String title: title of the book
   * @return true if library contains book
  ...
  /*
   * Method to check if title is available
   * @param String title: the book to be checked
   * @return false if book is not in collection or the value of title in collection !=true
   * @return false if title == true in hashtable
   */
  ...
  /*
   * Method to print all books in collection
   */
